...
// ============================================================
// features.js - Animace hoblin, social proof notifikace
// ============================================================
...
// ============================================================
// ANIMACE DŘEVĚNÝCH HOBLIN
// ============================================================

/**
 * Vytvoří efekt létajících hoblin při kliknutí
 * @param {Event} event - Kliknutí událost pro získání souřadnic
 */
export function createWoodShavings(event) {
    ...
    for (let i = 0; i < particleCount; i++) {
        ...
        // 50% šance na emoji, 50% na barevný čtvereček
        ...
        // Náhodný směr letu (nahoru a do stran)
...
// Seznam zpráv pro social proof (černý humor)
...
/**
 * Zobrazí náhodnou social proof notifikaci
 */
function showRandomSocialMessage() {
    ...
    // Speciální případ pro "{count - 1}" - musíme to vyhodnotit
...
/**
 * Naplánuje další social proof notifikaci (náhodný interval 20-40s)
 */
...
/**
 * Inicializace social proof notifikací
 */
export function initSocialProof() {
    // ============================================================
    // KONTROLA ZDA JE SOCIÁLNÍ PROOF POVOLEN
    // ============================================================
    if (!CONFIG.Enable_Social_Proof) {
        // Schováme celou notifikační lištu
    ...
    // První zpráva se objeví 8 sekund po načtení
    socialProofInterval = setTimeout(() => {
        showRandomSocialMessage();
        scheduleNextSocialProof();
    }, 8000);
