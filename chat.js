...
const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzQnojdop8MGahdXmg1OQW4DrjnxILvjvZ9B0vQmhVWQRmQ_kKNn12csJ_1z2nvElY/exec";
...
function initChat() {
    ...
    welcomeMsg.innerHTML = `👋 <b>Ahoj! Jsem Woodisek</b><br><br>Rád ti pomohu s objednávkou, dopravou nebo čímkoli dalším. Vyber si téma nebo napiš vlastní otázku! 🪵<span style="font-size: 12px; color: var(--text-dim);"></span>`;
...
async function sendUserMessage(message) {
    if (message.length > 600) {
        showToastInChat("📏 Zpráva je příliš dlouhá (max 600 znaků). Zkrať ji prosím a zkus znovu.", "✂️");
        return;
    }
